...
- 2026-07-25: `proposal-writing` を新規作成して一覧へ追加。問い合わせフォーム用パートナー提案文の構成設計・新規作成・辛口レビュー・ブラッシュアップ・一変数A/B案を扱い、第1弾はWeb制作会社向けGBP協業提案に限定。旧 `sales-copywriting` 系とは互換性を持たず、独立QAとランタイム品質ゲートは新設しない。
