...
rows = [{'_row': 129, 'sent_at': now, 'status': 'skipped', 'error_reason': '文字数制限あり(本文1949字がフォーム上限1000字を超過のため送信スキップ。共通本文のみで1735字あり本フォームには収まらない)', 'screenshot_path': '', 'provider_used': 'playwright_mcp'}]
