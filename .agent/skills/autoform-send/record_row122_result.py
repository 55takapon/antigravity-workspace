...
rows = [{'_row': 122, 'sent_at': now, 'status': 'failed', 'error_reason': '文字数制限は解消(1975字)も、reCAPTCHA v2(チェックボックス型)がクロスオリジンiframeでTier B操作不可。手動ハンドオフ要', 'screenshot_path': '', 'provider_used': 'playwright_mcp'}]
