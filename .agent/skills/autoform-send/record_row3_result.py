...
rows = [{'_row': 3, 'sent_at': now, 'status': 'failed', 'error_reason': '文字数制限は解消(1962字)も、reCAPTCHA v3スコア判定で送信失敗(Tier B/Playwright MCP手動操作でも不可・要再検討)', 'screenshot_path': '', 'provider_used': 'playwright_mcp'}]
