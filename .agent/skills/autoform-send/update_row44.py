...
rows = [{'_row': 44, 'sent_at': now, 'status': 'failed', 'error_reason': 'reCAPTCHA v3スコア判定で送信失敗(Tier B/Playwright MCP・headful操作でも不可・要再検討)', 'screenshot_path': '', 'provider_used': 'playwright_mcp'}]
