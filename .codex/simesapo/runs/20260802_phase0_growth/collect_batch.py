...
WEB_WORDS = ("ホームページ制作", "web制作", "ウェブ制作", "サイト制作", "webサイト", "集客支援", "マーケティング", "広告運用", "sns運用", "ブランディング", "開業支援", "開業サポート", "経営支援", "経営サポート", "予約システム", "予約管理", "pos", "モバイルオーダー", "注文システム", "顧客管理", "販促支援", "店舗支援", "店舗運営", "dx支援")
PROHIBIT_PATTERNS = [
