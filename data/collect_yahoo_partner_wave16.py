...
TERMS = [
    "リフォーム会社 集客マーケティング支援", "建設会社 採用マーケティング支援",
    "家具 インテリア 販促マーケティング", "幼稚園 保育園 広報支援会社",
    "専門学校 学生募集 マーケティング", "博物館 美術館 デジタルプロモーション",
    "レジャー施設 集客マーケティング", "温浴施設 SNS集客支援",
    "飲食チェーン 販促支援会社", "小売店舗 CRM 販促支援",
    "健康食品 デジタルマーケティング会社", "地域サービス業 Web集客支援",
]
...
with Path("data/sns_partner_candidates_wave16.csv").open("w", encoding="utf-8-sig", newline="") as handle:
