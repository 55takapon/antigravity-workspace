...
OFFICIAL_FILES.extend(Path(f"data/sns_secondary_official_{i}.csv") for i in range(10))
OFFICIAL_FILES.append(Path("data/sns_secondary_official_10_13.csv"))
...
AFFINITY_FILES.extend(Path(f"data/sns_secondary_affinity_{i}.csv") for i in range(10))
AFFINITY_FILES.append(Path("data/sns_secondary_affinity_10_13.csv"))
...
output = Path("data/sns_partner_recovered_noncompetitors_v14.csv")
