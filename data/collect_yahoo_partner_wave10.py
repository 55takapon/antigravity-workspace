...
TERMS = [
    "地域広告代理店 デジタル支援", "PR会社 SNSマーケティング",
    "クリエイティブ会社 Webマーケティング", "ブランディング会社 Web集客",
    "コンテンツマーケティング 支援会社", "LINE CRM マーケティング会社",
    "動画広告 マーケティング会社", "インフルエンサー マーケティング会社",
    "採用マーケティング SNS支援", "中小企業 デジタル販促会社",
]
...
with Path("data/sns_partner_candidates_wave10.csv").open("w", encoding="utf-8-sig", newline="") as handle:
