...
SOURCE = BASE / "construction_opener_kept.csv"
OUTPUT = BASE / "construction_final_verified_50.csv"
...
BAD_CONTACTS = {
    "https://www.jutaku-s.com/contact/", "https://a-zip.co.jp/contact/", "https://protimes.jp/contact/",
    "https://www.archi-book.com/contact/", "https://sekou-kyujin.com/contact/", "https://www.mamoris.jp/contact/",
    "https://jacof.co.jp/contact/", "https://www.jyusanken.co.jp/contact/", "https://www.housing-tribune.com/contact/",
}
...
for r in candidates:
    reasons=[]
    if r.get("contact_url", "") in BAD_CONTACTS: reasons.append("contact_unreachable")
