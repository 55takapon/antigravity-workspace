...
SOURCE = HERE / "pet_with_contacts.csv"
SEED = HERE / "pet_candidate_seed.csv"
AUDIT = HERE / "pet_preappend_audit.csv"
FINAL = HERE / "pet_final_verified_50.csv"
...
for row in candidates:
    ...
    if row.get("company_name", "").strip() in {
        "株式会社TYL",
        "Wellvet",
        "株式会社PeReP",
        "株式会社どうぶつの夢",
        ...
        decision, reason = "exclude", "company_identity_not_sufficient_or_same_operator_duplicate"
