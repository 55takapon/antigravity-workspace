...
TARGET = "シート1"
START = int(os.environ.get("AUDIT_START", "3663"))
END = int(os.environ.get("AUDIT_END", "3862"))
HERE = Path(os.environ.get("AUDIT_OUTPUT_DIR", str(Path(__file__).parent)))
...
snapshot = HERE / "final_200_readback.csv"
...
if len(rows) != 200 or missing or internal_company or internal_domain or external_conflicts:
