...
internal_company = {key: values for key, values in internal_company.items() if key and len(values) > 1}
internal_domain = {key: values for key, values in internal_domain.items() if key and len(values) > 1}
