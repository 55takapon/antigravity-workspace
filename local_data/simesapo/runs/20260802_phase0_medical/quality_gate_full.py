...
SERVICE = re.compile(r"(?:歯科|医科|医療|医院|クリニック|病院|動物病院|整骨院|接骨院|治療院|薬局|介護|福祉|訪問看護|障害福祉|障がい福祉|高齢者施設).{0,100}(?:ホームページ|web|ウェブ|サイト).{0,60}(?:制作|作成|運用|マーケティング|集患)|(?:ホームページ|web|ウェブ|サイト).{0,60}(?:制作|作成|運用|マーケティング).{0,100}(?:歯科|医科|医療|医院|クリニック|病院|動物病院|整骨院|接骨院|治療院|薬局|介護|福祉|訪問看護|障害福祉|障がい福祉|高齢者施設)")
